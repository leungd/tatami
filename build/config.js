module.exports = {
   ...
   * path without host.
   * E.g. your theme path is http://test.dev/wp-content/themes/tatami/
   * then your assets path is /wp-content/themes/tatami/
   *
   * This is for Webpack that it can handle assets relative path right.
   */
  assetsPath: '/wp-content/themes/tatami/',
